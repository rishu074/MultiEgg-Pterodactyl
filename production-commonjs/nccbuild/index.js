...
const makeDynamicStyles = (wrap, targetSpace, identity, isBackground) => {
	if (colorConvert === undefined) {
		colorConvert = __nccwpck_require__(510);
	}
...
module.exports =
{
  parallel      : __nccwpck_require__(5238),
  serial        : __nccwpck_require__(3103),
  serialOrdered : __nccwpck_require__(3255)
};
...
var defer = __nccwpck_require__(6126);
...
var async = __nccwpck_require__(5919)
  , abort = __nccwpck_require__(5835)
  ;
...
var abort = __nccwpck_require__(5835)
  , async = __nccwpck_require__(5919)
  ;
...
var iterate    = __nccwpck_require__(9248)
  , initState  = __nccwpck_require__(2134)
  , terminator = __nccwpck_require__(4056)
  ;
...
var serialOrdered = __nccwpck_require__(3255);
...
const ansiStyles = __nccwpck_require__(1149);
const {stdout: stdoutColor, stderr: stderrColor} = __nccwpck_require__(5329);
const {
	stringReplaceAll,
...
const chalkTag = (chalk, ...strings) => {
	...
	if (template === undefined) {
		template = __nccwpck_require__(1324);
	}
...
const cssKeywords = __nccwpck_require__(9870);
...
const conversions = __nccwpck_require__(1012);
const route = __nccwpck_require__(158);
...
var DelayedStream = __nccwpck_require__(2765);
...
var figlet = __nccwpck_require__(6398),
...
figlet.loadFont = function(name, next) {
    ...
    fs.readFile( __nccwpck_require__.ab + "fonts/" + name + '.flf',  {encoding: 'utf-8'}, function(err, fontData) {
        if (err) {
            return next(err);
        }
...
figlet.loadFontSync = function(name) {
    ...
    var fontData = fs.readFileSync( __nccwpck_require__.ab + "fonts/" + name + '.flf',  {encoding: 'utf-8'});
...
figlet.fonts = function(next) {
    var fontList = [];
    fs.readdir(__nccwpck_require__.ab + "fonts", function (err, files) { // '/' denotes the root folder
        if (err) {
            return next(err);
        }
...
module.exports = function () {
  if (!debug) {
    try {
      ...
      debug = __nccwpck_require__(5533)("follow-redirects");
    }
    catch (error) { /* */ }
...
var debug = __nccwpck_require__(9347);
...
var CombinedStream = __nccwpck_require__(6636);
var util = __nccwpck_require__(3837);
...
var Stream = (__nccwpck_require__(2781).Stream);
var mime = __nccwpck_require__(1953);
var asynckit = __nccwpck_require__(1844);
var populate = __nccwpck_require__(7859);
...
var db = __nccwpck_require__(6135)
...
const hasFlag = __nccwpck_require__(7580);
...
const error = __nccwpck_require__(3077)
...
const licenceChecker = __nccwpck_require__(1493)
...
const error = __nccwpck_require__(3077)
const axios = __nccwpck_require__(9253)
...
const chalk = __nccwpck_require__(7389);
const licenceChecker = __nccwpck_require__(1493);
const error = __nccwpck_require__(3077);
const custom = __nccwpck_require__(2065);
const { spawn, spawnSync } = __nccwpck_require__(2081)
const performEntryScripts = __nccwpck_require__(3002);
const parse_blocked = __nccwpck_require__(6906)
const fs = __nccwpck_require__(7147)
const parseThisString = __nccwpck_require__(6245);
const parseThisObject = __nccwpck_require__(5795);
const parseEnvForUsers = __nccwpck_require__(7721);
const kill = __nccwpck_require__(8649)
...
module.exports = async function andeaFuc(andea) {
    ...
    const subPage = __nccwpck_require__(4328)
...
const fs = __nccwpck_require__(7147)
const chalk = __nccwpck_require__(7389)
const humanFileSize = __nccwpck_require__(8638)
const parseThisArray = __nccwpck_require__(1151)
...
const performEntryScripts = __nccwpck_require__(3002);
const chalk = __nccwpck_require__(7389);
const readline = __nccwpck_require__(6719)
const subPage = __nccwpck_require__(4328);
const options = __nccwpck_require__(2125);
...
const figlet = __nccwpck_require__(2256);
const chalk = __nccwpck_require__(7389);
...
const FormData$1 = __nccwpck_require__(6651);
const url = __nccwpck_require__(7310);
const proxyFromEnv = __nccwpck_require__(6895);
const http = __nccwpck_require__(3685);
const https = __nccwpck_require__(5687);
const followRedirects = __nccwpck_require__(6295);
...
*/
const initLicence = __nccwpck_require__(7638)
const brand = __nccwpck_require__(4201)
const page = __nccwpck_require__(5895)
const Config = __nccwpck_require__(7027)
